...
function Timer({ interval, style }){
    //padding so numbers on the timer don't jump around when numbers hit < 10
...
function RoundButton({title, color, background, onPress, disabled}){
    return(
        <TouchableOpacity onPress = {() => !disabled && onPress()} style = {[styles.button, {backgroundColor: background}]} activeOpacity = {disabled ? 1.0 : 0.7}>
